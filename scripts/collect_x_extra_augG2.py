...
from mldftdat.data import get_unique_coord_indexes_spherical, compile_dataset
...
compile_dataset('augG2_x_extra_aug_80_100', MOL_IDS, SAVE_ROOT, CALC_TYPE,
        FUNCTIONAL, BASIS, RHFAnalyzer, append_all_rho_data = True)
