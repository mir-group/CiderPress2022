...
from mldftdat.density import get_ldax_dens
from pyscf import dft, scf, gto

mol = gto.Mole(atom='H 0 0 0; H 0 0 0.74', basis = 'def2-tzvp')
...
for i in range(8):
    ...
    ax.annotate('H', xy=(0.74/0.5291, 0), xytext=(0.74/0.5291-0.1, 0.05), fontsize=15)
